var Level = function () {
    ...
    var datatable = {
        init: function () {
            levelDatatable = $("#level_datatable").DataTable(options);
            this.initEvents();
        },
        reload: function () {
        ...
        initEvents: function () {
            ...
            levelDatatable.on("click",
                ...
                function () {
                    ...
                    Swal.fire({
                        title: "¿Está seguro?",
                        text: "El nivel será eliminado permanentemente",
                        type: "warning",
                        ...
                        preConfirm: () => {
                            return new Promise((resolve) => {
                                $.ajax({
                                    url: _app.parseUrl(`/api/niveles/${id}`),
                                    type: "delete",
                                    success: function (result) {
                                        ...
                                        swal({
                                            type: "success",
                                            title: "Completado",
                                            text: "El nivel ha sido eliminada con éxito",
                                    ...
                                    error: function (errormessage) {
                                        swal({
                                            ...
                                            text: "Ocurrió un error al intentar eliminar el nivel"
                                        });
                                    }
                                });
                            });
